...
static inline void POWER_EnablePmuInterrupt(uint32_t mask, bool enable)
{
    if (enable)
    {
        POWER_SetPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->IMSC), mask);
    }
    else
    {
        POWER_ClrPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->IMSC), mask);
    }
}
...
{
    POWER_WritePmuReg((void *)(uint32_t *)(uint32_t)(&PMU->GPREG[index]), data);
}
...
{
    return POWER_ReadPmuReg((void *)(uint32_t *)(uint32_t)(&PMU->GPREG[index]));
}
...
{
    return (POWER_ReadPmuReg((void *)(uint32_t *)(uint32_t)(&PMU->PCON)) & PMU_PCON_SLEEPFLAG_MASK) >> PMU_PCON_SLEEPFLAG_SHIFT;
}
...
{
    POWER_SetPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), PMU_PCON_SLEEPFLAG_MASK);
}
...
{
    return (POWER_ReadPmuReg((void *)(uint32_t *)(uint32_t)(&PMU->PCON)) & PMU_PCON_DPDFLAG_MASK) >> PMU_PCON_DPDFLAG_SHIFT;
}
...
{
    return (POWER_ReadPmuReg((void *)(uint32_t *)(uint32_t)(&PMU->PSTAT)) & PMU_PSTAT_DPDEXIT_MASK) >> PMU_PSTAT_DPDEXIT_SHIFT;
}
...
{
    POWER_SetPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), PMU_PCON_DPDFLAG_MASK);
}
...
static inline void POWER_EnableAutoPowerSwitch(bool enable)
{
    ...
    {
        POWER_SetPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), PMU_PCON_PMULPM_MASK);
    }
}
...
static inline void POWER_EnableAutoBatterySwitch(bool enable)
{
    if (enable)
    {
        POWER_ClrPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), PMU_PCON_VBAT_MASK);
    }
    else
    {
        POWER_SetPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), PMU_PCON_VBAT_MASK);
    }
}
...
static inline void POWER_EnableDetectBrownOut(bool enable)
{
    if (enable)
    {
        POWER_SetPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), PMU_PCON_BODEN_MASK);
    }
    else
    {
        POWER_ClrPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), PMU_PCON_BODEN_MASK);
    }
}
...
static inline void POWER_EnableWakeupPinForDeepPowerDown(power_dpd_wakeup_pin_t pin, bool enable)
{
    if (enable)
    {
        POWER_SetPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), (uint32_t)pin);
    }
    else
    {
        POWER_ClrPmuRegBit((void *)(uint32_t *)(uint32_t)(&PMU->PCON), (uint32_t)pin);
    }
}
...
{
    return (0UL != (PMU->ACCSTAT & PMU_ACCSTAT_PMU_READY_MASK));
}
...
{
    return POWER_ReadPmuReg((void *)(uint32_t *)(uint32_t)(&PMU->PSTAT));
}
...
{
    return POWER_ReadPmuReg((void *)(uint32_t *)(uint32_t)(&PMU->RIS));
}
...
{
    return POWER_ReadPmuReg((void *)(uint32_t *)(uint32_t)(&PMU->MIS));
}
...
{
    POWER_WritePmuReg((void *)(uint32_t *)(uint32_t)(&PMU->ICR), mask);
}
